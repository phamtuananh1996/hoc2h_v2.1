...
@section('content')
	<div class="card" ng-app="hoc2h-user" ng-controller="ctlUser">
		@include('admin.user.directives.modal_ban')
		@include('admin.user.directives.modal_active')
		@include('admin.user.directives.modal_edit')
		@include('admin.user.directives.modal_delete')
		@include('admin.user.directives.modal_warning')
		@include('admin.user.directives.model_multidelete')
		<div class="card-header b-a-0 col-md-12">
			...
			<button ng-click="multiactive()" class="btn btn-primary pull-right btn-sm" style="margin-right: 30px"><i class="fa fa-check" aria-hidden="true"></i> Active</button>
						...
						<tr ng-repeat="user in users| orderBy:'-id'"> 
							...
							<td>
								<div class="table-actions">
									<a ng-if="user.state==1" class="btn btn-sm btn-warning" href="" ng-click="ban(user.id)" data-toggle="tooltip" title="Ban">
										<i class="fa fa-ban" aria-hidden="true"></i>
									</a>
									<a ng-if="user.state==0" class="btn btn-sm btn-success" href="" ng-click="active(user.id)" data-toggle="tooltip" title="Active">
										<i class="fa fa-check" aria-hidden="true"></i>
									</a>&nbsp;
									<a href="/admin/users/{{user.id}}" class="btn btn-sm btn-primary" data-toggle="tooltip" title="Edit">
										<i class="fa fa-edit"></i>								
									</a>&nbsp;
									<a href="" class="btn btn-sm btn-danger" ng-click="delete(user.id)" data-toggle="tooltip" title="delete">
